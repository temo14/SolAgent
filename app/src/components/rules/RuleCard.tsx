  ...
  >
    <div className="flex items-center justify-between mb-8">
      ...
      <div className="flex gap-2">
        <button onClick={() => onDelete(rule.id)} className="p-3 hover:bg-red-50 rounded-full text-black/10 hover:text-red-500 transition-all">
          <Trash2 size={16} />
        </button>
      </div>
    </div>
    ...
    <div className="mt-8 pt-8 border-t border-black/5 grid grid-cols-2 gap-4">
      <div className="p-4 rounded-3xl bg-black/[0.02] border border-black/5">
        ...
        <div className="space-y-1">
          <div className="flex justify-between text-[10px]">
            ...
            <span className="font-bold">${rule.limits?.maxSpendPerDay ?? '—'}</span>
          </div>
          <div className="flex justify-between text-[10px]">
      ...
      <div className="p-4 rounded-3xl bg-black/[0.02] border border-black/5">
        ...
        <div className="space-y-1">
          ...
          <div className="flex justify-between text-[10px]">
            <span className="text-black/40">Last Run</span>
